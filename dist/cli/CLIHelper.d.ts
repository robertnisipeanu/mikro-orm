...
export declare class CLIHelper {
    static getConfiguration<D extends IDatabaseDriver = IDatabaseDriver>(validate?: boolean): Promise<Configuration<D>>;
    static getORM(warnWhenNoEntities?: boolean): Promise<MikroORM>;

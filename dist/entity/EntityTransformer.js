...
class EntityTransformer {
    static toObject(entity, ignoreFields = [], visited = []) {
        ...
        const ret = (wrapped.__primaryKey && !pkProp.hidden ? { [pk]: platform.normalizePrimaryKey(wrapped.__primaryKey) } : {});
        if ((!wrapped.isInitialized() && wrapped.__primaryKey) || visited.includes(EntityHelper_1.wrap(entity).__uuid)) {
            return ret;
        }

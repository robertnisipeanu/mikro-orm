...
class CriteriaNode {
    constructor(metadata, entityName, parent, key, validate = true) {
        ...
        if (meta && key) {
            ...
            if (validate && !this.prop && !key.includes('.') && !QueryBuilderHelper_1.QueryBuilderHelper.isOperator(key) && !QueryBuilderHelper_1.QueryBuilderHelper.isCustomExpression(key)) {

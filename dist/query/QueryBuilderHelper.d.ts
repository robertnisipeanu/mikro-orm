...
export declare class QueryBuilderHelper {
    ...
    constructor(entityName: string, alias: string, aliasMap: Record<string, string>, metadata: MetadataStorage, knex: Knex, platform: Platform);
    ...
    getQueryOrder(type: QueryType, orderBy: FlatQueryOrderMap, populate: Record<string, string>): {
        column: string;
        order: string;
    }[];

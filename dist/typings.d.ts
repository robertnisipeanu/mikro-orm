...
export declare type DeepPartialEntity<T> = {
    [P in keyof T]?: null | (T[P] extends (infer U)[] ? DeepPartialEntity<U>[] : T[P] extends ReadonlyArray<infer U> ? ReadonlyArray<DeepPartialEntity<U>> : T extends Date | RegExp ? T : DeepPartialEntity<T[P]> | PartialEntity<T[P]> | Primary<T[P]>);
};
...
export declare type IPrimaryKeyValue = number | string | {
    toHexString(): string;
};
...
export declare type UnionOfArrays<T> = T extends infer T1 | infer T2 | infer T3 | infer T4 | infer T5 | infer T6 | infer T7 | infer T8 | infer T9 | infer T10 ? T1[] | T2[] | T3[] | T4[] | T5[] | T6[] | T7[] | T8[] | T9[] | T10[] : T extends infer T1 | infer T2 | infer T3 | infer T4 | infer T5 | infer T6 | infer T7 | infer T8 | infer T9 ? T1[] | T2[] | T3[] | T4[] | T5[] | T6[] | T7[] | T8[] | T9[] : T extends infer T1 | infer T2 | infer T3 | infer T4 | infer T5 | infer T6 | infer T7 | infer T8 ? T1[] | T2[] | T3[] | T4[] | T5[] | T6[] | T7[] | T8[] : T extends infer T1 | infer T2 | infer T3 | infer T4 | infer T5 | infer T6 | infer T7 ? T1[] | T2[] | T3[] | T4[] | T5[] | T6[] | T7[] : T extends infer T1 | infer T2 | infer T3 | infer T4 | infer T5 | infer T6 ? T1[] | T2[] | T3[] | T4[] | T5[] | T6[] : T extends infer T1 | infer T2 | infer T3 | infer T4 | infer T5 ? T1[] | T2[] | T3[] | T4[] | T5[] : T extends infer T1 | infer T2 | infer T3 | infer T4 ? T1[] | T2[] | T3[] | T4[] : T extends infer T1 | infer T2 | infer T3 ? T1[] | T2[] | T3[] : T extends infer T1 | infer T2 ? T1[] | T2[] : T extends infer T1 ? T1[] : never;
export declare type OneOrArray<T> = T | UnionOfArrays<T>;
export declare type GroupOperatorMap<T> = {
    $and?: UnionOfArrays<Query<T>>;
    $or?: UnionOfArrays<Query<T>>;
};
...
export declare type EntityOrPrimary<T> = true extends IsEntity<T> ? DeepPartialEntity<T> | PartialEntity<T> | Primary<T> | T : never;
...
export declare type Query<T> = true extends IsEntity<T> ? {
    [K in keyof T]?: Query<T[K]> | FilterValue<T[K]> | null;
} | FilterValue<T> : T extends Collection<infer K> ? {
    [KK in keyof K]?: Query<K[KK]> | FilterValue<K[KK]> | null;
} | FilterValue<K> : FilterValue<T>;
export declare type FilterQuery<T> = GroupOperatorMap<Query<T>> | Query<T> | {
    [PrimaryKeyType]?: any;
};
